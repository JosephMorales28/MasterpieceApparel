...
class DeepSeaMonsterSweatShirtMainProduct{
    constructor(image,alt,loading,priority){
        this.image=image;
        this.alt=alt;
        this.loading=loading;
    ...
    getDeepSeaMonsterSweatShirtMainProduct(){
        return `
                <img src="${this.image}" alt="${this.alt}" loading="${this.loading===0 ? "eager" : "lazy"}" fetchpriority="${this.priority===0 ? "high" : "auto"}" decoding= "async"/>
               `
    }
...
class DeepSeaMonsterPremiumOversizedHoodieMainProduct{
    constructor(image,alt,loading,priority){
        this.image=image;
        this.alt=alt;
        this.loading=loading;
    ...
    getDeepSeaMonsterPremiumOversizedHoodieMainProduct(){
        return `
                <img src="${this.image}" alt="${this.alt}" loading="${this.loading===0 ? "eager" : "lazy"}" fetchpriority="${this.priority===0 ? "high" : "auto"}" decoding= "async"/>
               `
    }
...
class DeepSeaMonsterLightweightHoodieMainProduct{
    constructor(image,alt,loading,priority){
        this.image=image;
        this.alt=alt;
        this.loading=loading;
    ...
    getDeepSeaMonsterLightweightHoodieMainProduct(){
        return `
                <img src="${this.image}" alt="${this.alt}" loading="${this.loading===0 ? "eager" : "lazy"}" fetchpriority="${this.priority===0 ? "high" : "auto"}" decoding= "async"/>
               `
    }
...
export function deepseamonstersweatshirt_main(){
    
    const deppseamonstersweatshirtmain_product=[
        new DeepSeaMonsterSweatShirtMainProduct(
            "/img/idontfish.webp",
            "Deep Sea Monster ",
            0,
            0
    ...
    const deepseamonstersweatshirtinfo={
        name:"Deep Sea Monster </br>(Sweat Shirt)",
        creator:"Joseph Morales",
        Price: 30.69,
        details:"Dive into the abyss with this Deep Sea Monster artwork a colossal Kraken rising from storm‑tossed waves. Its glowing eyes, razor‑sharp teeth, and curling tentacles crush a doomed ship beneath a fiery moon. The arced, cracked lettering “DEEP SEA” and “MONSTER” frame the creature in a bold, mythic composition perfect for dark‑fantasy fans, ocean explorers, and streetwear collectors.",
        type:"Unisex, T-Shirts",
    ...
    const deepseamonstersweatshirtHTML=deppseamonstersweatshirtmain_product.map(deepseamonstersweatshirtMP=>deepseamonstersweatshirtMP.getDeepSeaMonsterSweatShirtMainProduct()).join('');
    
    const deepseamonstersweatshirtinfoHTML=`
        <h1>${deepseamonstersweatshirtinfo.name}</h1>
        <p>Created by : ${deepseamonstersweatshirtinfo.creator}</p>
        <strong>$ ${deepseamonstersweatshirtinfo.Price.toFixed(2)}</strong>
        <h4>Details</h4>
        <p>${deepseamonstersweatshirtinfo.details}</p>
        <h4>Type:</h4>
        <p>${deepseamonstersweatshirtinfo.type} are ${deepseamonstersweatshirtinfo.fabric}</p>
        <h4>Size Available</h4>
        <p>${deepseamonstersweatshirtinfo.size.s}, ${deepseamonstersweatshirtinfo.size.m}, ${deepseamonstersweatshirtinfo.size.l}, ${deepseamonstersweatshirtinfo.size.xl}, ${deepseamonstersweatshirtinfo.size.xxl}, ${deepseamonstersweatshirtinfo.size.xxxl}</p>
        `;
    ...
    return `
            <main>
              <div id="product_main">
                 <div class="production_flex">
                    <div>
                        ${deepseamonstersweatshirtHTML}
                    </div>
                    <div>
                         ${deepseamonstersweatshirtinfoHTML}
...
export function deepseamonstersweatshirt_gallery(){

    const deepseamonstersweatshirtgallery={
        img: "/img/gallery1.webp",
        alt:"Deep Sea Monster"
    }
    return `
          <div id="deepseamonstersweatshirtgallery">
              <h1>Image Product</h1>
              <div class="deepseamonstersweatshirt_gallery_flex">
                 <img src="${deepseamonstersweatshirtgallery.img}" alt="${deepseamonstersweatshirtgallery.alt}" loading="lazy" fetchpriority="high" decoding="async"/>
                 <img src="${deepseamonstersweatshirtgallery.img}" alt="${deepseamonstersweatshirtgallery.alt}" loading="lazy" fetchpriority="high" decoding="async"/>
                 <img src="${deepseamonstersweatshirtgallery.img}" alt="${deepseamonstersweatshirtgallery.alt}" loading="lazy" fetchpriority="high" decoding="async"/>
                 <img src="${deepseamonstersweatshirtgallery.img}" alt="${deepseamonstersweatshirtgallery.alt}" loading="lazy" fetchpriority="high" decoding="async"/>
                 </div>
...
export function deepseamonsterpremiumoversizedhoodie_main(){
    
    const deppseamonsterpremiumoversizedhoodiemain_product=[
        new DeepSeaMonsterPremiumOversizedHoodieMainProduct(
            "/img/idontfish.webp",
            "Deep Sea Monster ",
            0,
            0
    ...
    const deepseamonsterpremiumoversizedhoodieinfo={
        name:"Deep Sea Monster </br>(Premium Oversized Hoodie)",
        creator:"Joseph Morales",
        Price: 30.69,
        details:"Dive into the abyss with this Deep Sea Monster artwork a colossal Kraken rising from storm‑tossed waves. Its glowing eyes, razor‑sharp teeth, and curling tentacles crush a doomed ship beneath a fiery moon. The arced, cracked lettering “DEEP SEA” and “MONSTER” frame the creature in a bold, mythic composition perfect for dark‑fantasy fans, ocean explorers, and streetwear collectors.",
        type:"Unisex, T-Shirts",
    ...
    const deepseamonsterpremiumoversizedhoodieHTML=deppseamonsterpremiumoversizedhoodiemain_product.map(deepseamonsterpremiumoversizedhoodieMP=>deepseamonsterpremiumoversizedhoodieMP.getDeepSeaMonsterPremiumOversizedHoodieMainProduct()).join('');
    
    const deepseamonsterpremiumoversizedhoodieinfoHTML=`
        <h1>${deepseamonsterpremiumoversizedhoodieinfo.name}</h1>
        <p>Created by : ${deepseamonsterpremiumoversizedhoodieinfo.creator}</p>
        <strong>$ ${deepseamonsterpremiumoversizedhoodieinfo.Price.toFixed(2)}</strong>
        <h4>Details</h4>
        <p>${deepseamonsterpremiumoversizedhoodieinfo.details}</p>
        <h4>Type:</h4>
        <p>${deepseamonsterpremiumoversizedhoodieinfo.type} are ${deepseamonsterpremiumoversizedhoodieinfo.fabric}</p>
        <h4>Size Available</h4>
        <p>${deepseamonsterpremiumoversizedhoodieinfo.size.s}, ${deepseamonsterpremiumoversizedhoodieinfo.size.m}, ${deepseamonsterpremiumoversizedhoodieinfo.size.l}, ${deepseamonsterpremiumoversizedhoodieinfo.size.xl}, ${deepseamonsterpremiumoversizedhoodieinfo.size.xxl}, ${deepseamonsterpremiumoversizedhoodieinfo.size.xxxl}</p>
        `;
    ...
    return `
            <main>
              <div id="product_main">
                 <div class="production_flex">
                    <div>
                        ${deepseamonsterpremiumoversizedhoodieHTML}
                    </div>
                    <div>
                         ${deepseamonsterpremiumoversizedhoodieinfoHTML}
...
export function deepseamonsterpremiumoversizedhoodie_gallery(){

    const deepseamonsterpremiumoversizedhoodiegallery={
        img: "/img/gallery1.webp",
        alt:"Deep Sea Monster"
    }
    return `
          <div id="deepseamonsterpremiumoversizedhoodiegallery">
              <h1>Image Product</h1>
              <div class="deepseamonsterpremiumoversizedhoodie_gallery_flex">
                 <img src="${deepseamonsterpremiumoversizedhoodiegallery.img}" alt="${deepseamonsterpremiumoversizedhoodiegallery.alt}" loading="lazy" fetchpriority="high" decoding="async"/>
                 <img src="${deepseamonsterpremiumoversizedhoodiegallery.img}" alt="${deepseamonsterpremiumoversizedhoodiegallery.alt}" loading="lazy" fetchpriority="high" decoding="async"/>
                 <img src="${deepseamonsterpremiumoversizedhoodiegallery.img}" alt="${deepseamonsterpremiumoversizedhoodiegallery.alt}" loading="lazy" fetchpriority="high" decoding="async"/>
                 <img src="${deepseamonsterpremiumoversizedhoodiegallery.img}" alt="${deepseamonsterpremiumoversizedhoodiegallery.alt}" loading="lazy" fetchpriority="high" decoding="async"/>
                 </div>
...
export function deepseamonsterlightweighthoodie_main(){
    
    const deppseamonsterlightweighthoodiemain_product=[
        new DeepSeaMonsterLightweightHoodieMainProduct(
            "/img/idontfish.webp",
            "Deep Sea Monster ",
            0,
            0
    ...
    const deepseamonsterlightweighthoodieinfo={
        name:"Deep Sea Monster </br>(Lightweight Hoodie)",
        creator:"Joseph Morales",
        Price: 30.69,
        details:"Dive into the abyss with this Deep Sea Monster artwork a colossal Kraken rising from storm‑tossed waves. Its glowing eyes, razor‑sharp teeth, and curling tentacles crush a doomed ship beneath a fiery moon. The arced, cracked lettering “DEEP SEA” and “MONSTER” frame the creature in a bold, mythic composition perfect for dark‑fantasy fans, ocean explorers, and streetwear collectors.",
        type:"Unisex, T-Shirts",
    ...
    const deepseamonsterlightweighthoodieHTML=deppseamonsterlightweighthoodiemain_product.map(deepseamonsterlightweighthoodieMP=>deepseamonsterlightweighthoodieMP.getDeepSeaMonsterLightweightHoodieMainProduct()).join('');
    
    const deepseamonsterlightweighthoodieinfoHTML=`
        <h1>${deepseamonsterlightweighthoodieinfo.name}</h1>
        <p>Created by : ${deepseamonsterlightweighthoodieinfo.creator}</p>
        <strong>$ ${deepseamonsterlightweighthoodieinfo.Price.toFixed(2)}</strong>
        <h4>Details</h4>
        <p>${deepseamonsterlightweighthoodieinfo.details}</p>
        <h4>Type:</h4>
        <p>${deepseamonsterlightweighthoodieinfo.type} are ${deepseamonsterlightweighthoodieinfo.fabric}</p>
        <h4>Size Available</h4>
        <p>${deepseamonsterlightweighthoodieinfo.size.s}, ${deepseamonsterlightweighthoodieinfo.size.m}, ${deepseamonsterlightweighthoodieinfo.size.l}, ${deepseamonsterlightweighthoodieinfo.size.xl}, ${deepseamonsterlightweighthoodieinfo.size.xxl}, ${deepseamonsterlightweighthoodieinfo.size.xxxl}</p>
        `;
    ...
    return `
            <main>
              <div id="product_main">
                 <div class="production_flex">
                    <div>
                        ${deepseamonsterlightweighthoodieHTML}
                    </div>
                    <div>
                         ${deepseamonsterlightweighthoodieinfoHTML}
...
export function deepseamonsterlightweighthoodie_gallery(){

    const deepseamonsterlightweighthoodiegallery={
        img: "/img/gallery1.webp",
        alt:"Deep Sea Monster"
    }
    return `
          <div id="deepseamonsterlightweighthoodiegallery">
              <h1>Image Product</h1>
              <div class="deepseamonsterlightweighthoodie_gallery_flex">
